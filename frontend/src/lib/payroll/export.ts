...
export async function exportPayrollDetailExcel(record: PayrollRecord): Promise<void> {
  ...
  const rows = [
    ...
    ['Transportation Allowance', '', record.transportationAllowance],
    ['Meal Allowance', '', record.mealAllowance],
...
export async function exportPayrollDetailPDF(record: PayrollRecord): Promise<void> {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ['Housing Allowance', record.housingAllowance.toLocaleString('en-EG', { minimumFractionDigits: 2 })],
      ['Transportation Allowance', record.transportationAllowance.toLocaleString('en-EG', { minimumFractionDigits: 2 })],
      ['Meal Allowance', record.mealAllowance.toLocaleString('en-EG', { minimumFractionDigits: 2 })],
      ['Other Allowances', record.otherAllowances.toLocaleString('en-EG', { minimumFractionDigits: 2 })],
